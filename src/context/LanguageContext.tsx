...
export const translations = {
    es: {
        ...
        hero_title: 'Asesoría Legal, Estratégica y Corporativa',
        hero_subtitle: 'Soluciones claras y adaptadas a tus necesidades reales. Enfócate en hacer crecer tu negocio mientras nosotros blindamos tus operaciones y activos clave.',
        cta_consult: 'Solicitar Consulta Estratégica',
